        ...
        if (!directoryPath.isEmpty()) {
          ...
          if (directory.exists() && directory.isDirectory()) {
            ...
            if (vo != null) {
              ...
              popUpError(inputHandler, frameJO.getFrame(), "No picture at this directory.", "Error 0");

            }
          } else {
            popUpError(inputHandler, frameJO.getFrame(), "Invalid directory path.", "Error 1");
          }
        } else {
          popUpError(inputHandler, frameJO.getFrame(), "Please enter a directory path.", "Error 2");
        }
      }
    });
